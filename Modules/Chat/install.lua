...
function C:InstallChat()
	...
	for i = 1, 2 do
		Blizzard_CombatLog_Filters.filters[i].settings.timestamp = true
		Blizzard_CombatLog_Filters.filters[i].settings.braces = true
		Blizzard_CombatLog_Filters.filters[i].settings.spellBraces = true
	end

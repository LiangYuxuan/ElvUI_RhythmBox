...
local function PremadeGroupsFilter()
    R:RegisterAddOnLoad('AddOnSkins', function()
        local _, _, S = unpack(AddOnSkins)

        R:RegisterAddOnLoad('PremadeGroupsFilter', function()
...
RS:RegisterPipeline(PremadeGroupsFilter)
